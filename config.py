...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Shivmis/Musbrand",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/stickers_Channell")
SUPPORT_CHAT = getenv("SUPPORT_2", "https://t.me/shivang_xd")
